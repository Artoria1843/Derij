...
export function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // petición al backend
      const res = await axios.post("http://localhost:3001/registro", {
        name: formData.name,
      ...
      // mensaje de error del backend o genérico
      alert(error.response?.data?.msg || "Error al registrar usuario");
    }
  };

  // ==============================
  // UI (DISEÑO NO MODIFICADO)
  // ==============================
  return (
        ...
        <div className="w-full md:w-1/2 bg-[#e9ebe2] p-8 md:p-14 flex flex-col justify-center">
          ...
          <div className="max-w-sm w-full mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full py-3 bg-[#c10a16] text-white rounded-xl font-bold"
              >
                CREAR CUENTA
              </button>
