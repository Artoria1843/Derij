...
export function AdminProducts() {
  ...
  const [vista, setVista] = useState<"menu" | "agregar" | "editar" | "eliminar">("menu");
  ...
  const [editando, setEditando] = useState<ProductoEditando | null>(null);
    ...
    <div className="min-h-screen bg-gray-100 p-10">
      ...
      {vista === "menu" && (
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-3xl font-bold mb-8">Panel de Productos</h1>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold">Agregar</h2>
              <p className="text-gray-500">Nuevo producto</p>
            </div>
            ...
            >
              ...
              <p className="text-gray-500">Modificar productos</p>
            </div>
            ...
            <div
              ...
              className="bg-white p-6 rounded-xl shadow cursor-pointer hover:scale-105 transition"
            >
              <h2 className="text-xl font-semibold text-red-600">Eliminar</h2>
              <p className="text-gray-500">Borrar productos</p>
            </div>
...
/>
            ...
            {preview && (
              <img src={preview} className="h-40 object-cover rounded border"/>
            )}
          ...
          <button onClick={() => setVista("menu")} className="mt-4 text-gray-500">
            ← Volver
          </button>
      ...
      {/* ================= LISTA ================= */}
      {(vista === "editar" || vista === "eliminar") && (
        <div className="max-w-5xl mx-auto">

          <h2 className="text-2xl font-bold mb-6">
            {vista === "editar" ? "Editar Productos" : "Eliminar Productos"}
          </h2>
          ...
          <button onClick={() => setVista("menu")} className="mt-6 text-gray-500">
            ← Volver
          </button>
...
/>
            ...
            <img
              src={getImageUrl(editando.imagen)}
            ...
            <div className="flex gap-2 mt-4">
              ...
              <button onClick={() => setEditando(null)} className="flex-1">
                Cancelar
              </button>
